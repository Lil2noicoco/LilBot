...
client.on("ready", () => {
    ...
    client.channels.get("500994125311639554");
...
client.on('message', async message => { 
    ...
    if(message.content === prefix + "BD") {
      var mod_embed = new Discord.RichEmbed()
      .setColor('RANDOM')
      .setTitle(`:video_game: Voici mes commandes en rapport au branleur de dindon !`)
      .setThumbnail(message.author.avatarURL)
      .addField("*didon", "Grace a la commande *dindon tu peux devenir un dindon ! ")
      .setFooter("Commande pour Branleur de Dindon - LilBOT")
      .setTimestamp()
      message.channel.send(mod_embed);
      console.log('Le bot envoie la liste BD');
    }
